...
const rulesByType = {
  byr: (value) => /\d{4}/.test(value) && Number(value) >= 1920 && Number(value) <= 2002,
  iyr: (value) => /\d{4}/.test(value) && Number(value) >= 2010 && Number(value) <= 2020,
  eyr: (value) => /\d{4}/.test(value) && Number(value) >= 2020 && Number(value) <= 2030,
  hgt: (value) => {
